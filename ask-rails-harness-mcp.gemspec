...
Gem::Specification.new do |spec|
  spec.name = "ask-rails-harness-mcp"
  spec.version = Ask::Rails::MCP::VERSION
  spec.authors = ["Kaka Ruto"]
  spec.email = ["kaka@myrrlabs.com"]

  spec.summary = "MCP server for Rails app introspection — exposes ask-rails-harness tools over the Model Context Protocol"
  ...
  spec.homepage = "https://github.com/ask-rb/ask-rails-harness-mcp"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.2"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = spec.homepage
  spec.metadata["changelog_uri"] = "https://github.com/ask-rb/ask-rails-harness-mcp/blob/master/CHANGELOG.md"

  spec.files = Dir["lib/**/*", "bin/*", "LICENSE", "README.md", "CHANGELOG.md"]
  spec.bindir = "bin"
  spec.executables = ["ask-rails-harness-mcp"]
